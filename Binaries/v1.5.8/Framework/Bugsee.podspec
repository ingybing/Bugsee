Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '5.0'
  s.source       = { :http => "http://download.bugsee.com/sdk/ios/Bugsee-1.5.8.zip" }
  s.source_files = 'Bugsee.framework/Versions/A/Headers/*.h'
  s.resources    = 'Bugsee.bundle'
  s.preserve_paths =  'Bugsee.framework/*', 'Bugsee.bundle'
  ...
  s.libraries    = 'c++'
  s.xcconfig     =  { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/Bugsee/"', 'CLANG_CXX_LANGUAGE_STANDARD' => 'c++11', 'CLANG_CXX_LIBRARY' => 'libc++' }
  s.requires_arc = true
end
